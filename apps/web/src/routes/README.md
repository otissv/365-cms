...
| ----- | ---- | ---- | ---- |
| `/collections/[collectionName]` | - | `CollectionsCollectionName` | `<CollectionsCollectionName.Link>` |
| `/collections` | - | `Collections` | `<Collections.Link>` |
| `/` | - | `Home` | `<Home.Link>` |
...
- [ ] `/collections/[collectionName]/page.info.ts`: Add search typing to if the page supports search paramaters
- [ ] Convert `Link` components for `/collections/[collectionName]` to `<CollectionsCollectionName.Link>`
- [ ] Convert `params` typing in `/collections/[collectionName]/page.ts` to `z.infer<>`
- [ ] `/collections/page.info.ts`: Add search typing to if the page supports search paramaters
- [ ] Convert `Link` components for `/collections` to `<Collections.Link>`
