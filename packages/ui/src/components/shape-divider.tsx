...
const Triangle = ({ fill, svgClassName }: ShapeProps) => {
  return (
    ...
    <svg
      ...
      className={svgClassName}
    >
      <path d='M1200 0L0 0 598.97 114.72 1200 0z' className={fill} />
    </svg>
  )
}
...
const TriangleAsymmetrical = ({ fill, svgClassName }: ShapeProps) => {
  return (
    ...
    <svg
      ...
      className={svgClassName}
    >
      <path d='M1200 0L0 0 892.25 114.72 1200 0z' className={fill} />
    </svg>
  )
}
...
const Tilt = ({ fill, svgClassName }: ShapeProps) => {
  return (
    ...
    <svg
      ...
      className={svgClassName}
    >
      <path d='M1200 120L0 16.48 0 0 1200 0 1200 120z' className={fill} />
    </svg>
  )
}
...
const Arrow = ({ fill, svgClassName }: ShapeProps) => {
  return (
    ...
    <svg
      ...
      className={svgClassName}
    >
      <path d='M649.97 0L550.03 0 599.91 54.12 649.97 0z' className={fill} />
    </svg>
  )
}
