...
import { cmsColumnDialogValidator } from "../validators.cms"
import type { CmsCollectionColumn, CmsColumnDialog } from "../types.cms"
...
function SubmitForm({
  ...
  onClose: () => void
  onSubmit: (
    values: CmsColumnDialog
  ) => Promise<undefined | Partial<CmsCollectionColumn>[]>
}) {
